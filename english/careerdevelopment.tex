...
\subrubric{SolarCity - San Mateo CA USA / aquired by Tesla 12/2016 }
\entry*[08/2015 - today] \textbf{Sr. Director: IT Infrastructure,Devops and Security}\newline
\textax{Content:} 
Accountable for 24/7 operations, build \& deployment of all apps and services across technology stacks and hostings solutions (on-prem \& cloud). Improving Information security \& complicance posture, policy, standards and procedures. Test


\textax{Role:} 
Leading and developing four teams (Server, Network, Devops and Security) through hypergrowth and post growth consolidation. Took the teams from regular outages to weeks without incident by establishing processes, needed talent and spirit to do the right thing while supporting a fast growing organization. 
